                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4">
                                    <img class="img-thumbnail" src="{{ asset('uploads/customers/'.$schedule->customer->avatar)}}" width="100"/>
                                </div>
                                <div class="col-8">
                                    <div class="row">
                                        <div class="col-xs-12">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="row d-flex">
                                <div class="col-4 ">
                                    <img class="img-fluid" src="{{ asset('uploads/artists/'.$schedule->artist->avatar)}}" width="100"/>
                                </div>
                                <div class="col-8 ">
                                    <div class="row">
                                        <div class="col-xs-12">
