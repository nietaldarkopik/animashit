                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="mb-3">
                            ...
                            <p class="form-control">{{ $portfolio->gig->title }}</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="mb-3">
                            <strong class="form-label">Artist</strong>
                            <p class="form-control">{{ $portfolio->artist->nickname }}</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="row">
                            ...
                            @foreach ($packages as $i => $pack)
                                @php
                                    $datapacktmp = $pack->gigPackages->where('gig_package_head_id', '=', $portfolio->id)->first();
