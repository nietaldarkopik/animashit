...
<div class="row">
    <div class="col-12 z-1 top-0 left-0 p-0 fixed-bottom carousel-modal">
        {{-- <a class="btn btn-lg z-3 btn-warning top-0 left-0 m-5" href="javascript:void(0);"
            data-bs-dismiss="modal" data-bs-placement="bottom" data-bs-toggle="popover" title="Close"
            data-bs-title="Close" data-bs-content="Close">
            <i class="fas fa-caret-left"></i> Back
        </a> --}}
        <div id="carouselArtistDetail" class="carousel slide vh-sm-100  z-1 top-0 left-0 p-3 p-sm-0"
    ...
    <div class="col-12 z-2 col-xxl-9 col-sm-9 z-2 fixed-bottom left-0 p-0">
        <div class="row bg-animashit-primary-trans mx-0">
            ...
            <div class="col-10">
                ...
                <ol
                    ...
                    @foreach ($porfolios as $ip => $p)
                        <li data-bs-target="#carouselArtistDetail" data-bs-slide-to="{{ $ip }}"
        ...
        <div class="accordion accordion-flush mt-5" id="accordionFlushExample">
            <div class="accordion-item bg-animashit-primary-trans">
                <h2 class="accordion-header" id="flush-headingOne">
                    <a href="javascript:void(0);" class="accordion-button collapsed text-decoration-none"
                        data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" data-bs-parent="#flush-collapseOne"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <h4 class="text-light card-title ff-oswald placeholder-artist-job">
            ...
            <div class="accordion-item bg-animashit-primary-trans">
                <h2 class="accordion-header" id="flush-headingTwo">
                    <a href="javascript:void(0);" class="accordion-button collapsed text-decoration-none"
                        data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" data-bs-parent="#flush-collapseTwo"
                                                ...
                                                @foreach ($ph->packages as $ip => $p)
                                                    <li class="nav-item" role="presentation">
                                                        <a href="#"
                                                            ...
                                                            id="package-{{ $p->id }}" data-bs-toggle="tab"
                                                            data-bs-target="#target-{{ $p->id }}" role="tab"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                ...
                                                                @if (is_array($extrafeatures) and count($extrafeatures) > 0)
                                                                    <h6 class="text-outline1 text-white my-3">
                                                                        Extra Features</h6>
