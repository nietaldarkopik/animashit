...
class AdmGigsController extends Controller
{
    ...
    {
        $gigs = GigModel::orderBy('id', 'DESC')->paginate(10);
        return view('backend.pages.gigs.index', compact('gigs'));
    }

    public function create()
    {
        return view('backend.pages.gigs.create');
    }

    public function store(Request $request)
    {
        $this->validate($request, [
            'title' => 'required|unique:gigs,title'
        ]);
    ...
    public function show($id)
    {
        ...
        return view('backend.pages.gigs.show', compact('gig'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.gigs.edit', compact('gig'));
    }
    ...
    {
        DB::table("gigs")->where('id', $id)->delete();
        return redirect()->route('admin.gigs.index')
